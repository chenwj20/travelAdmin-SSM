				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline" >
							...
							<select class="form-control" id="changeCount" onchange="changeCount()">
								<option>2</option>
								<option>5</option>
								<option>10</option>
								<option>15</option>
						...
						<ul class="pagination">
							...
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum-1}&pageSize=${pageInfo.pageSize}">上一页</a></li>
								...
								<c:if test="${pageInfo.pages>10}">
									...
									<c:if test="${pageInfo.pageNum >5 and pageInfo.pageNum+5 <= pageInfo.pages}">
									<c:forEach begin="${pageInfo.pageNum-4}" end="${pageInfo.pageNum+5}" var="page">
										<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>
									</c:forEach>
									</c:if>
									<c:if test="${pageInfo.pageNum+5>pageInfo.pages}">
										<c:forEach begin="${pageInfo.pageNum-4}" end="${pageInfo.pages}" var="page">
											<li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${page}&pageSize=${pageInfo.pageSize}">${page}</a></li>
										</c:forEach>
									</c:if>
								</c:if>
